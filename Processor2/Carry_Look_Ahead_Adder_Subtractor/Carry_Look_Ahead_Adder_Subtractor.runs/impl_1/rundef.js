...
ISEStep( "vivado",
         "-log Carry_Look_Ahead_Adder_Subtractor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Carry_Look_Ahead_Adder_Subtractor.tcl -notrace" );
