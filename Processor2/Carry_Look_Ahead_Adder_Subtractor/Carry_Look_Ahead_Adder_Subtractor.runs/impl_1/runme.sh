...
HD_PWD='L:/Documents/Xilinx/Vivado/Carry_Look_Ahead_Adder_Subtractor/Carry_Look_Ahead_Adder_Subtractor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Carry_Look_Ahead_Adder_Subtractor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Carry_Look_Ahead_Adder_Subtractor.tcl -notrace
