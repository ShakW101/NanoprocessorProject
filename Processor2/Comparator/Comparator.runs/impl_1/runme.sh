...
HD_PWD='L:/Documents/Xilinx/Vivado/Comparator/Comparator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Comparator_Latch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Comparator_Latch.tcl -notrace
