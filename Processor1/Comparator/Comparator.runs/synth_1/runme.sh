...
HD_PWD='L:/Documents/Xilinx/Vivado/Comparator/Comparator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Comparator_Latch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Comparator_Latch.tcl
